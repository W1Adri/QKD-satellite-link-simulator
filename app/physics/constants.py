...
# --- Sky background / radiance constants ---
# Source: ASTM E490 solar reference spectrum; Pirandola et al., Adv. Opt. Photon. 12, 1012 (2020)
SOLAR_SPECTRAL_IRRAD_810NM_W_M2_NM: float = 0.48   # W/m^2/nm at AM0, 810 nm
LUNAR_MEAN_ALBEDO: float = 0.12                      # Bond albedo of the Moon (average)
